App = {
  ...
  listenForEvents: async function() {
    let instance = await App.contracts.DappTokenSale.deployed();
    instance.Sell({}, {
      fromBlock: 0,
      toBlock: 'latest',
  ...
  render: async function() {
    ...
    let tokensSold = await dappTokenSaleInstance.tokenSold();
  ...
  buyTokens: async function() {
    ...
    let instance = await App.contracts.DappTokenSale.deployed();
    let result =  await instance.buyTokens(numberOfTokens, {
                                    from: App.account,
